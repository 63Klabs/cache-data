...
describe('Property-Based Tests: JSDoc Parsing Security', () => {
     ...
     */
    it('Property 2: JSDoc Bracket Matching Correctness - correctly parses nested brackets', () => {
            ...
            fc.property(
                ...
                (type, paramName, description) => {
                    ...
                    if (result !== null) {
                        ...
                        expect(result.name).toBe(paramName);
                    }
                }
            ),
            {
     ...
     */
    it('Property 3: JSDoc Parser Resilience - handles malformed input gracefully', () => {
            ...
            fc.property(
                ...
                (type, paramName) => {
                    ...
                    try {
                        ...
                        throw new Error(`Parser threw error on malformed input: ${error.message}`);
                    }
                    ...
                    expect(result === null || (typeof result === 'object' && result.hasOwnProperty('name'))).toBe(true);
                }
            ),
            {
                numRuns: 100,
     ...
     */
    it('Property 2b: JSDoc Bracket Matching - @returns tag handles nested brackets', () => {
        const nestedBracketArbitrary = fc.tuple(
            fc.constantFrom('string', 'number', 'boolean', 'Object', 'Array', 'Promise'),
     ...
     */
    it('Property 2c: JSDoc Bracket Matching - @throws tag handles nested brackets', () => {
        const nestedBracketArbitrary = fc.tuple(
     ...
     */
    it('Property 3b: JSDoc Parser Resilience - specific malformed patterns', () => {
            ...
            fc.property(
                ...
                (type, paramName) => {
                    ...
                    try {
                        ...
                        throw new Error(`Parser threw error on malformed input "${type}": ${error.message}`);
                    }
     ...
     */
    it('Property 6: Backwards Compatibility - new implementation matches expected behavior', () => {
        ...
        fc.assert(
            fc.property(
                ...
                (type, paramName, description, isOptional) => {
                    ...
                    expect(result.optional).toBe(isOptional);
                }
            ),
            {
                numRuns: 100,
     ...
     */
    it.skip('Property 6b: Backwards Compatibility - default values are extracted correctly', () => {
