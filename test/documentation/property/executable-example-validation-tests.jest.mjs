...
describe("Executable Example Validation - Property-Based Tests", () => {
	...
	describe("Property 15: Executable Example Validation", () => {
		...
		it("should have syntactically valid JavaScript in all documentation examples", async () => {
		...
		it("should use property-based testing to verify example executability", async () => {
		...
		it("should validate that examples use proper module imports", async () => {
			const docsDir = path.join(__dirname, '../../../docs');
			const readmeFile = path.join(__dirname, '../../../README.md');
		...
		it("should validate that examples don't use deprecated APIs", async () => {
			const docsDir = path.join(__dirname, '../../../docs');
			const readmeFile = path.join(__dirname, '../../../README.md');
